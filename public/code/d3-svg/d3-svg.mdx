...
create a line, start at point (10, 10), end at (100, 100). 通过 d3,
...
## Sample
<CodePen html="/code/d3-svg/d3-svg-viewbox.html" css="/code/d3-svg/d3-svg.css"/>
...
meet/slice 都是通过最小程度的缩放(保持 viewBox aspect ratio) 调整 viewBox 的大小， meet 让 viewport 刚好包含 viewBox, slice 就是 viewBox 刚好包含 viewport.  
 ...
 * 当只指定 viewBox 时，元素中的大小是根据 viewBox 大小来， viewport 默认使用 *width: 100%*, 纵横比和 viewBox 保持一致.
...
# Sample
<CodePen html="/code/d3-svg/d3-svg.html" deps="/code/d3-svg/d3-svg.json" code="/code/d3-svg/d3-svg.jsx" css="/code/d3-svg/d3-svg.css"/>
